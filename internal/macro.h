...
#define MIHATSU_IS_BLANKETED(token) MIHATSU_NARGS_SELECTOR(_MIHATSU_IS_BLANKETED_IMPL, _MIHATSU_0_COMMA_0 token)
#define _MIHATSU_0_COMMA_0(...) 0, 0
#define _MIHATSU_IS_BLANKETED_IMPL1(...) 0
#define _MIHATSU_IS_BLANKETED_IMPL2(...) 1
